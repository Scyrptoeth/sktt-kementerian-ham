...
export const metadata: Metadata = {
  ...
  description:
    "Platform latihan Seleksi Kompetensi Teknis Tambahan Kementerian HAM RI. 12 soal esai berbasis kasus nyata, skor otomatis, pembahasan langsung.",
  keywords: [
    "SKTT",
    "Kementerian HAM",
    "latihan ujian",
  ...
  openGraph: {
    title: "Latihan SKTT Kementerian HAM",
    description:
      "12 soal esai berbasis kasus nyata · skor otomatis · pembahasan langsung. Persiapkan SKTT Kementerian HAM RI.",
  ...
  twitter: {
    ...
    title: "Latihan SKTT Kementerian HAM",
    description:
      "12 soal esai berbasis kasus nyata · skor otomatis · pembahasan langsung.",
  },
};
